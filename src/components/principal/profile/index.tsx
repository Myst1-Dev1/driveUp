        ...
        <>
            <div className="container py-12 mt-20 grid grid-cols-1 lg:grid-cols-3 lg:gap-0">
                <div className="mb-12 lg:mb-0 lg:max-w-60 w-full rounded-xl border border-gray-300">
                    <Image className="my-4 w-24 h-24 block mx-auto object-cover aspect-square rounded-full" src={profile?.avatarUrl || "/images/user.jpg"} width={200} height={200} alt="foto do usuário" />
                    <h2 className="text-xl text-center font-bold">{profile?.fullName}</h2>
