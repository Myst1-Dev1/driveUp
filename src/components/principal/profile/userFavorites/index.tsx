    ...
    return (
        <>
            <div className="grid grid-cols-1 gap-5 lg:grid-cols-3 overflow-y-auto h-full scrollDontShow lg:h-96">
                <Link href="/car/1" className="lg:max-w-72 w-full p-3 rounded-lg bg-[#fff] flex flex-col gap-3">
                    <div className="flex justify-between">
                        <div className="flex flex-col gap-1">
                            <h3 className="font-bold">Koenigsegg</h3>
                            <h4 className="text-[#848484] font-light text-sm">Sport</h4>
                        </div>
                        <FaHeart className="text-red-500 transition-all duration-500 cursor-pointer hover:text-blue-600" />
                    </div>
