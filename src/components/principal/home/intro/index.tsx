    ...
    return (
        <>
            <div className="relative flex justify-center flex-col gap-3 items-center w-full min-h-[60vh] lg:min-h-screen rounded-bl-[60px] rounded-br-[60px] lg:rounded-bl-[500px] lg:rounded-br-[500px] overflow-hidden">
                ...
                <h1 className="text-white text-center font-bold text-2xl lg:text-4xl z-10">
                    A Melhor Plataforma Para <br /> Aluguel de Carros
                </h1>
                <p className="font-light text-sm text-white text-center max-w-80 w-full z-10">
                    Abrimos a porta para você explorar o mundo com conforto e estilo, sendo seu parceiro de viagem de confiança
                </p>
                <Link
                    href="#carros"
                    className="z-40 text-center block mx-auto max-w-32 w-full p-3 bg-black text-white rounded-full border-none cursor-pointer mt-4 font-semibold transition-all duration-500 hover:bg-blue-600"
                >
                    Ver Carros
                </Link>
            </div>
            <Image
                className="m-auto -mt-32 lg:-mt-[260px] max-w-3xl w-full relative z-20"
