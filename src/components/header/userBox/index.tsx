        ...
        <>
            <div className="absolute top-20 z-30 shadow-md shadow-gray-500 right-5 bg-white max-w-48 w-full rounded-xl">
                ...
                <div className="p-3 flex justify-center items-center flex-col gap-2">
                    <Image className="w-12 h-12 object-cover aspect-square rounded-full" src="/images/user.jpg" width={200} height={200} alt="foto do usuário" />
                ...
                <div className="border-t border-gray-300 py-3">
                    <div className="cursor-pointer px-3 text-sm flex gap-3 items-center transition-all duration-500 hover:bg-blue-400 hover:text-white">
                        <FaSignOutAlt /> Sair
                    </div>
                </div>
            </div>
