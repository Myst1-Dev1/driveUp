        ...
        <>
            <header className="container py-6 flex justify-between w-full absolute top-0 left-0 right-0">
                ...
                <div className={`flex flex-col lg:flex-row gap-5 items-center transition-all duration-500 lg:max-w-md w-full lg:relative lg:bg-transparent justify-center lg:justify-normal z-20 bg-white fixed top-0 lg:left-0 ${isMobileMenuOpen ? 'left-0' : '-left-full'} right-0 h-full`}>
                    ...
                    <button onClick={() => setIsModalOpen(true)} className="bg-zinc-800 text-white rounded-xl max-w-20 w-full p-2 cursor-pointer transition-all duration-500 hover:bg-blue-600">Login</button>
            ...
            <Modal maxWidth="96" isOpenModal={isModalOpen} setIsOpenModal={setIsModalOpen}>
                <div className="py-4">
                    ...
                    <form action="" className="mt-5">
                        <input className="mb-5 input" type="email" placeholder="Email" />
                        <input className="input" type="password" placeholder="Senha" />
                        <span className="font-light text-center block text-sm mt-3">Não possui uma conta? <span className="text-blue-400 font-medium cursor-pointer transition-all duration-500 hover:text-blue-600">Cadastro</span></span>
